 ...
 * between dorkd, and dork-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dorkchain/dork>";
    const std::string URL_WEBSITE = "<https://dorkchain.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Dork Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Dork useful. "
