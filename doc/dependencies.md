...
These are the dependencies currently used by Dork. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/dorknl
Keybase  - https://keybase.io/team/dork/
