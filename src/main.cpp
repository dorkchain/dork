...
#if defined(NDEBUG)
# error "Dork cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Dork Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Dork also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Dork also requires low S in sigs
