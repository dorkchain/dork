...
const QString BITCOIN_IPC_PREFIX("dork:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/dork-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/dork-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/dork-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click dork: links
...
//
// OSX-specific way of handling dork: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in dork: URIs
...
bool PaymentServer::handleURI(const QString &scheme, const QString &s)
{
    ...
    else
    {
        Q_EMIT message(tr("URI handling"), tr("URI cannot be parsed! This can be caused by an invalid "
                                              "Dork address or malformed URI parameters."),
            CClientUIInterface::ICON_WARNING);
    }
