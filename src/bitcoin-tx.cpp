...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dork-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dork transaction") + "\n" +
              "  dork-tx [options] -create [commands]   " + _("Create hex-encoded dork transaction") + "\n" +
              "\n";
