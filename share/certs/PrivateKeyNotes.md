...
unlocked to sign the Dork-Qt.app bundle.
...
allowing somebody to distribute a Dork-Qt.app or dork-qt-setup.exe with a valid
...
that the dork-qt.exe file inside the installer had not been tampered with.
